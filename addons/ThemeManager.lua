...
--  TCOLib-based scripts.
-- ─────────────────────────────────────────────

local ThemeManager = {}

ThemeManager.Folder    = 'TCOLibSettings'
ThemeManager.Library   = nil
ThemeManager.DefaultTheme = 'TCO Yellow'

-- ── Built-in themes ───────────────────────────
-- Format: [name] = { sortIndex, colorTable }

ThemeManager.BuiltInThemes = {
    -- TCO yellow theme — bright warm yellow on dark grey (matches TCO profile picture)
    ['TCO Yellow'] = { 1, HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"ffcc00","BackgroundColor":"141414","OutlineColor":"323232"}') },
    -- Companion green theme — same shape, green accent (e.g. lime/olive)
    ['Lime']        = { 2, HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"9acd32","BackgroundColor":"141414","OutlineColor":"323232"}') },
    -- Dark yellow/olive variant for low-glare building sessions
    ['Olive']       = { 3, HttpService:JSONDecode('{"FontColor":"f5f5dc","MainColor":"1c1c14","AccentColor":"b8a217","BackgroundColor":"131310","OutlineColor":"3a3a28"}') },
    -- Classic BBot (kept for parity with peal-lib)
    ...
    -- Midnight — neutral fallback
    ['Midnight']    = { 5, HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"191925","AccentColor":"5a5a5a","BackgroundColor":"0d0d14","OutlineColor":"262638"}') },
}
